...
%Notably, some patients (e.g., Patient 563 and Patient 559) show significant deviations even at intermediate subsampling rates, highlighting interpatient variability in the impact of data reduction.
...
%, reflecting the impact of reduced sampling frequency on reconstruction fidelity. 
...
\begin{figure*}[p] % "ht" means "here" or "top", a positioning option
	\centering
...
\begin{itemize}
	...
	%This is particularly evident for patients with a higher initial percentage of time in hyperglycemia (e.g., orange and blue dots), indicating that increased subsampling may underestimate time spent in elevated glucose levels.
\end{itemize}
